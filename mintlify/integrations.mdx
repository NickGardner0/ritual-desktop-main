---
title: "Integrations"
description: "Wearable, health, desktop, and Plaid-backed financial integrations used to bring behavior and spending data into Ritual."
---
...
Plaid is the first financial integration in Ritual. It is used to help users track spending behavior, not to provide a full banking or budgeting product.

In the current build, Ritual:
...
Ritual Watcher and Ritual Recorder are separate from the unified wearables API. They are first-party desktop context features, not third-party integrations.

For detailed docs on computer tracking, OCR capture, memory indexing, and hybrid search, see [Context Understanding](/context-understanding).
