          ...
          <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 shadow-lg max-h-64 overflow-y-auto">
            {suggestions.map((suggestion, index) => (
              <button
                ...
                className={`w-full px-3 py-2.5 text-left flex items-center gap-3 hover:bg-gray-50 ${
                  selectedIndex === index ? 'bg-gray-50' : ''
                }`}
              >
                {suggestion.type === 'habit' && (
                  <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium bg-blue-50 text-blue-700">
                    Habit
                  </span>
                )}
