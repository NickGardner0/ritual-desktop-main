...
| Remaining projections documented | Tinybird inventory. Typesense deleted. MiniSearch stays for the in-modal picker. Dashboard Tinybird reads go through FastAPI. Overview/metrics, chat, calendar, activity-log, Tesla/Whoop, integration overview, Apple Health JSON, Oura/Garmin, Plaid, and onboarding reads use the generated client. Catch-all remains for markdown/CSV Apple export, home/SSO bootstrap, import, privacy, and watcher cookie reads. |
