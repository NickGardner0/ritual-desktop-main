...
**Canonical current baseline:** 187,601 after the additive durable-chat boundary, measured by `npm run audit:loc`; see [`LOC_BASELINE.md`](./LOC_BASELINE.md). The starting ship SHA measured 187,086.
