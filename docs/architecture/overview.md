...
| Authored LOC in 180k–185k | **No.** Canonical implementation total is **190,894**. |
...
1. **Canonical LOC is 190,894**, not 180k–185k. The checked-in audit command and bucket data supersede the historical estimates. Further reductions must come only from unreachable code or ownership consolidation, not live product cuts.
...
| **LOC reduction into 180k–185k** | measurement | Not achieved; canonical total is 190,894 and no product deletion is authorized for the metric. |
...
4. Keep the 180k–185k band as a deletion/consolidation target only. If 190,894 cannot be reduced without live product loss, record the honest final result instead of naming product to cut for the metric.
