...
**`apps/dashboard/app/api/chat/stream/route.ts`** (NEW)
...
**`apps/dashboard/app/api/chat/habits/route.ts`** (EXISTING)
...
```
✅ apps/dashboard/components/ai-habit-chat.tsx - Added chat mode UI + streaming
✅ apps/dashboard/app/api/chat/stream/route.ts - NEW streaming endpoint
✅ apps/dashboard/app/api/chat/habits/route.ts - Updated with all metric types
```
