...
| File | Size | Reason |
|------|------|--------|
| `apps/dashboard/app/debug/page.tsx` | 4.7KB | Debug-only page, not for production |
| `apps/dashboard/app/sentry-test/page.tsx` | 1.1KB | Test page, not for production |
| `apps/dashboard/app/api/debug/tinybird-logs/route.ts` | 1.6KB | Debug API endpoint |
| `apps/dashboard/app/api/debug/tinybird-sql/route.ts` | 1.6KB | Debug API endpoint |
| `apps/dashboard/lib/server-analytics.ts` | 2.3KB | Never imported anywhere |
| `apps/dashboard/components/timer/CompactTimer.tsx` | 6.9KB | Unused component |
| `apps/dashboard/components/timer/TimeTracker.tsx` | 8.1KB | Unused (TimeTrackerWidget is used instead) |
| `apps/dashboard/components/ui/use-toast.ts` | 3.9KB | Duplicate of `apps/dashboard/hooks/use-toast.ts` |
| `apps/dashboard/hooks/use-mobile.tsx` | 0.6KB | Unused hook |
| `apps/dashboard/components/ui/use-mobile.tsx` | 0.6KB | Unused hook |
...
The `.dmg` or `.app` file will be in `apps/desktop/src-tauri/target/release/bundle/`.
...
- `apps/dashboard/app/sentry-test/page.tsx`
- `apps/dashboard/app/api/debug/tinybird-logs/route.ts`
- `apps/dashboard/app/api/debug/tinybird-sql/route.ts`
- `apps/dashboard/lib/server-analytics.ts`
- `apps/dashboard/components/timer/CompactTimer.tsx`
- `apps/dashboard/components/timer/TimeTracker.tsx`
- `apps/dashboard/components/ui/use-toast.ts`
- `apps/dashboard/hooks/use-mobile.tsx`
- `apps/dashboard/components/ui/use-mobile.tsx`
