...
| `packages/ui/tokens.json` | Framework-neutral machine-readable token source |
...
| Role | CSS token | Light | Dark | Use |
|---|---|---|---|---|
| Canvas | `--ritual-surface-canvas` | `#fefefe` | `#0b0b0c` | Application background |
| Raised | `--ritual-surface-raised` | `#ffffff` | `#151516` | Menus and separated cards |
| Panel | `--ritual-surface-panel` | `#f4f4f3` | `#151516` | Grouped settings |
| Recessed | `--ritual-surface-recessed` | `#f7f8f5` | `#101011` | Wells and empty regions |
| Primary text | `--ritual-text-primary` | `#111111` | `#f7f7f3` | Titles and primary copy |
| Secondary text | `--ritual-text-secondary` | `#666666` | `#b8b8b2` | Supporting copy |
| Muted text | `--ritual-text-muted` | `#7a7a7a` | `#9a9a94` | Metadata |
| Default border | `--ritual-border-default` | `#dad9d7` | `#1d1d1d` | Inputs and separators |
| Focus / info | `--ritual-focus-ring` | `#306774` | `#72a8b4` | Keyboard focus and information |
...
|---|---|---|
| Info | `#306774` | `#72a8b4` |
| Success | `#167046` | `#55a67c` |
| Warning | `#b45309` | `#d49a56` |
| Danger | `#9f2d20` | `#d97368` |
...
Settings may also offer selectable UI fonts (GT Standard, GT America, Waldenburg, Inter, DM Sans, Geist Sans). Do not introduce another default product font family without updating `packages/ui/tokens.json`, `variables.css`, this document, and the visual reference.
...
3. Use `packages/ui/tokens.json` for machine-readable values and `variables.css` for framework-neutral CSS.
...
- `DESIGN.md`, `DESIGN.html`, `packages/ui/tokens.json`, `variables.css`, and `theme.css` as guidelines and attachments.
...
- Machine source: `packages/ui/tokens.json`
