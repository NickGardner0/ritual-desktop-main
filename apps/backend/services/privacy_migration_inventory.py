...
DIRECT_USER_SPECS: tuple[InventoryCategorySpec, ...] = (
    ...
    InventoryCategorySpec("backend_turso", "calendar_events", CalendarEventDB, "Calendar events"),
    InventoryCategorySpec("backend_turso", "calendar_occurrences", CalendarOccurrenceDB, "Calendar occurrences"),
    InventoryCategorySpec("backend_turso", "calendar_sources", CalendarSourceDB, "Calendar sources"),
    InventoryCategorySpec("backend_turso", "calendar_sync_runs", CalendarSyncRunDB, "Calendar sync history"),
    ...
    InventoryCategorySpec("backend_turso", "experiment_entries", ExperimentEntryDB, "Experiment workspace entries"),
...
SUPPORTED_MIGRATION_CATEGORIES = {
    ...
    "calendar_sync_runs": "Calendar sync history",
...
DELETION_PARENT_DEPENDENCIES = {
    ...
    "tasks": {"task_events"},
    "calendar_events": {"calendar_occurrences"},
    "calendar_sources": {"calendar_occurrences", "calendar_events", "calendar_sync_runs"},
}
...
DIRECT_MIGRATION_MODELS = {
    ...
    "calendar_events": (CalendarEventDB, "calendar_event"),
    "calendar_occurrences": (CalendarOccurrenceDB, "calendar_occurrence"),
    "calendar_sources": (CalendarSourceDB, "calendar_source"),
    "calendar_sync_runs": (CalendarSyncRunDB, "calendar_sync_run"),
