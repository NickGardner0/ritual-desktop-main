...
class OuraService:
    ...
    async def sync_oura_data(
        ...
        *,
        ...
        personal_info = await self.get_personal_info(access_token)

        async with httpx.AsyncClient(timeout=25.0) as client:
            daily_sleep = await self._fetch_collection(
                client,
                access_token,
                "daily_sleep",
            ...
            sleep = await self._fetch_collection(
                client,
                access_token,
                "sleep",
                start_date.isoformat(),
            ...
            daily_readiness = await self._fetch_collection(
                client,
                access_token,
                "daily_readiness",
                start_date.isoformat(),
            ...
            daily_activity = await self._fetch_collection(
                client,
                access_token,
                "daily_activity",
                start_date.isoformat(),
            ...
            workout = await self._fetch_collection(
                client,
                access_token,
                "workout",
                start_date.isoformat(),
            ...
            heartrate = await self._fetch_collection(
                client,
                access_token,
                "heartrate",
                start_date.isoformat(),
