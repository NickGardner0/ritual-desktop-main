...
async def sync_to_computer_use_habit(
    ...
    """
    Sync computer time to the user's "Computer Use" habit.
...
async def reconcile_computer_use_habit_projection(
    ...
    """
    Reconcile Computer Use projection rows in habit_logs against local watcher data.
...
async def get_computer_use_habit_projection_parity(
    ...
    """
    Validate parity between local Computer Activity totals and projected Computer Use habit totals.
