...
def test_entity_types_map_to_privacy_classes():
    ...
    assert data_class_for_entity_type("calendar_event") == "calendar_event"
    assert data_class_for_entity_type("calendar_occurrence") == "calendar_event"
    assert data_class_for_entity_type("calendar") == "calendar_event"
