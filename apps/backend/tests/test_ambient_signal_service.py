...
from services.ambient_signal_service import AmbientSignalService


class AmbientSignalServiceTests(unittest.IsolatedAsyncioTestCase):
    def test_daily_narrative_candidate_only_appears_inside_window(self):
        service = AmbientSignalService()
