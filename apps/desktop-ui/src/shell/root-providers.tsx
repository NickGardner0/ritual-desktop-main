/**
 * Vite-native desktop shell providers.
 *
 * Hosted Next keeps using `apps/dashboard/components/root-providers.tsx`.
 * This copy imports the disk-session Clerk adapter and the React Router
 * navigation adapter directly so Index does not talk to `@clerk/nextjs`
 * or `next/navigation`.
 */
...
import { ClerkProvider } from '../adapters/clerk';
