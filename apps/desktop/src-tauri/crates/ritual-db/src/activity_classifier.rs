...
pub fn classify_activity(
    ...
    let (primary_type, confidence) = scores.first()
        .cloned()
        .unwrap_or((ActivityType::Other, 0.0));
    
    // Get secondary types (other high-scoring types)
    let secondary_types: Vec<ActivityType> = scores.iter()
        .skip(1)
...
fn detect_coding(bundle: &str, app: &str, title: &str, ocr: &str) -> f64 {
    let ide_bundles = [
        "com.microsoft.vscode", "com.cursor", "com.jetbrains", 
        "com.apple.dt.xcode", "com.sublimetext", "com.vim",
        "org.vim", "com.neovim", "io.neovim", "com.github.atom",
        "com.googlecode.iterm2", "com.apple.terminal",
    ];
    
    let ide_apps = [
        "code", "cursor", "intellij", "pycharm", "webstorm", "goland",
        "clion", "rider", "phpstorm", "rubymine", "datagrip",
        "xcode", "sublime", "atom", "vim", "neovim", "emacs",
    ...
    let code_ocr_patterns = [
        ...
        "class ", "struct ", "impl ", "fn ", "def ", "async ", "await",
        "return ", "if (", "for (", "while (", "=>", "->", "::",
        "pub fn", "pub struct", "pub enum", "interface ", "type ",
    ];
...
fn detect_terminal(bundle: &str, app: &str, title: &str) -> f64 {
    let terminal_bundles = [
        ...
        "com.github.wez.wezterm", "co.zeit.hyper", "io.alacritty",
    ];
    ...
    let terminal_apps = ["terminal", "iterm", "kitty", "wezterm", "hyper", "alacritty"];
    ...
    if title.contains("bash") || title.contains("zsh") || title.contains("fish") 
       || title.contains("~$") || title.contains("ssh ") {
        return 0.85;
    }
...
fn detect_browsing(bundle: &str, app: &str) -> f64 {
    ...
    let browser_apps = ["chrome", "safari", "firefox", "edge", "brave", "opera", "vivaldi", "arc"];
...
fn detect_communication(bundle: &str, app: &str, title: &str) -> f64 {
    let email_bundles = [
        ...
        "com.readdle.smartemail", "com.freron.mailmate", "com.superhuman",
    ];
...
fn detect_messaging(bundle: &str, app: &str, title: &str) -> f64 {
    let messaging_bundles = [
        "com.tinyspeck.slackmacgap", "com.discord", "com.hnc.discord",
        "com.apple.imessage", "com.apple.messages", "com.whatsapp",
        "org.telegram.desktop", "com.microsoft.teams",
    ];
    ...
    let messaging_apps = [
        "slack", "discord", "messages", "imessage", "whatsapp", 
...
fn detect_video_call(bundle: &str, app: &str, title: &str) -> f64 {
    let video_bundles = [
        "us.zoom.xos", "com.google.chrome.app.zoom", "com.microsoft.teams",
        "com.apple.facetime", "com.loom", "com.webex",
    ];
...
fn detect_documents(bundle: &str, app: &str, title: &str) -> f64 {
    let doc_bundles = [
        "com.microsoft.word", "com.apple.pages", "com.notion",
        "md.obsidian", "com.craft.craft", "com.notion.id",
    ];
    ...
    let doc_apps = ["word", "pages", "notion", "obsidian", "craft", "bear", "ulysses"];
    for a in doc_apps {
        if app.contains(a) {
            return 0.9;
        }
...
fn detect_spreadsheets(bundle: &str, app: &str, title: &str) -> f64 {
    let sheet_bundles = [
        "com.microsoft.excel", "com.apple.numbers", "com.airtable",
    ];
...
fn detect_design(bundle: &str, app: &str, title: &str) -> f64 {
    let design_bundles = [
        ...
        "com.adobe.illustrator", "com.adobe.xd", "com.canva",
    ];
...
fn detect_media(bundle: &str, app: &str, title: &str) -> f64 {
    let media_bundles = [
        "com.spotify.client", "com.apple.music", "com.apple.quicktimeplayer",
        "org.videolan.vlc", "com.colliderli.iina", "com.netflix",
        "com.apple.tv", "com.youtube",
    ];
    ...
    let media_apps = [
        "spotify", "music", "vlc", "iina", "quicktime", "netflix",
        "youtube", "plex", "infuse",
    ];
    for a in media_apps {
        if app.contains(a) {
...
fn detect_file_management(bundle: &str, app: &str) -> f64 {
    let file_bundles = [
        "com.apple.finder", "com.panic.transmit", "app.cyberduck",
    ];
...
fn detect_system(bundle: &str, app: &str, title: &str) -> f64 {
    ...
    let system_apps = ["system preferences", "system settings", "activity monitor", "console"];
...
fn detect_reading(bundle: &str, app: &str, title: &str) -> f64 {
    let reading_bundles = [
        "com.apple.preview", "com.apple.books", "com.readdle.pdfexpert",
        "com.adobe.reader", "com.kindle",
    ];
