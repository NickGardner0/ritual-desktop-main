...
1. **`apps/desktop/ritual-icon/icon_combined.svg`** - Vector source combining:
...
2. **`apps/desktop/ritual-icon/icon_1024.png`** - 1024×1024 PNG export

3. **`apps/desktop/ritual-icon/Ritual.iconset/`** - Complete iconset folder with all required sizes:
   - icon_16x16.png
...
4. **`apps/desktop/ritual-icon/Ritual.icns`** - Final macOS icon file (241KB)

5. **`apps/desktop/src-tauri/icons/Ritual.icns`** - Copied to Tauri icons directory
...
- [x] apps/desktop/src-tauri/tauri.conf.json updated to point to "icons/Ritual.icns"
