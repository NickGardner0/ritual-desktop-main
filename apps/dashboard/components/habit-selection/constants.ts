...
export const categoryRowClass =
  'ritual-snappy-row ritual-snappy-row-muted-menu group flex h-9 items-center justify-between gap-3 -mx-2 rounded-sm px-2.5 text-[#2c2b28] [&_p]:text-[13.5px] [&_p]:font-medium [&_p]:tracking-normal [&_p]:text-[#2c2b28] [&_svg]:text-[#222326]';
