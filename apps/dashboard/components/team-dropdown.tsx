    ...
    <div className="relative w-full" ref={triggerRef}>
      ...
      {isActive && sidebarMenuPosition && typeof document !== 'undefined'
        ? createPortal(
            <div
              ref={menuRef}
              className="team-dropdown-menu fixed z-[1200] rounded-sm border border-[#DCDAD2] bg-[#FFFFFF] shadow-none"
              style={{
            ...
            >
              ...
              <div className="p-1">
                <button
                  ...
                  className="team-dropdown-row w-full cursor-pointer rounded-sm px-2 py-1 text-left text-sm text-black ritual-snappy-row ritual-snappy-row-menu focus:bg-[#F3F3F3]"
                >
                  Profile
                </button>
              ...
              <div className="border-t border-[#DCDAD2] p-1 team-dropdown-divider">
                <button
                  ...
                  className="team-dropdown-row w-full cursor-pointer rounded-sm px-2 py-1 text-left text-sm text-black ritual-snappy-row ritual-snappy-row-menu focus:bg-[#F3F3F3] disabled:opacity-50 disabled:cursor-not-allowed"
                >
