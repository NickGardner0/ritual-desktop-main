  ...
  return (
    <>
      <div
        ref={setNodeRef}
        style={style}
        className={`group grid w-full grid-cols-[minmax(0,1fr)_max-content] items-center gap-x-4 min-h-[29px] rounded-[6px] px-1 py-[1px] bg-[var(--content-bg)] hover:bg-[#f6f6f5] cursor-grab active:cursor-grabbing ${
