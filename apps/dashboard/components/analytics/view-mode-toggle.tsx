...
export const ViewModeToggle: React.FC<ViewModeToggleProps> = ({
  ...
  return (
    <div
      className={cn(
        "app-toolbar-segmented-control inline-flex items-center gap-0.5 rounded-sm bg-[#F3F3F3]/70 p-[3px]",
        className
      )}
      role="tablist"
    ...
    >
      {TABS.map((tab) => (
        <button
          ...
          className={cn(
            "h-7 rounded-sm px-3.5 text-[13px] transition-all duration-200",
            ...
            currentView === tab.value
              ...
              : "bg-transparent text-[rgba(39,37,30,0.75)] font-normal hover:bg-white/45 hover:text-[#27251E]"
          )}
        >
          {tab.label}
        </button>
