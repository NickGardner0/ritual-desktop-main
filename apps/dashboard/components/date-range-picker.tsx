      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              isTitlebar
                ? "titlebar-control h-7 w-[122px] justify-between rounded-[8px] px-2.5 py-1 text-left text-[13px] font-normal text-[rgba(17,24,39,0.72)] hover:text-[rgba(17,24,39,0.94)] focus-visible:ring-1 focus-visible:ring-[rgba(15,23,42,0.18)] focus-visible:ring-offset-0"
          ...
          >
            <CalendarIcon className={cn("mr-2 h-3.5 w-3.5", isTitlebar && "text-[rgba(17,24,39,0.58)]")} />
