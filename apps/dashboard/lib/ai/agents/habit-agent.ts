...
- When showing top apps/websites, present as a ranked list
  ...
  Project/Task Time Guidelines:
  - For "what was I working on" questions, answer from computer activity/project-time totals when those tools are available.
  - Prefer aggregate behavior and project/task durations over raw screen-content recall.
</agent-specific-rules>`,
  tools: createTools,
  maxTurns: 5,
  matchOn: [
    ...
    // Project/task attribution keywords
    'what was i doing', 'when did i', 'working on', 'project', 'task', 'deep work',
    'focus time', 'admin', 'research',
  ],
});
