const ritualTokens = require("./tailwind.tokens.cjs");
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: ritualTokens.borderRadius,
      boxShadow: ritualTokens.boxShadow,
      keyframes: {
        "accordion-down": {
          from: { height: 0 },
      ...
      fontFamily: ritualTokens.fontFamily,
      opacity: {
        '0': '0',
        '5': '0.05',
        '10': '0.1',
