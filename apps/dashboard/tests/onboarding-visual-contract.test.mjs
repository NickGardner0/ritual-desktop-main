...
test('feature tour describes Ritual devices, imports, tasks, routines, and analytics', async () => {
  ...
  assert.doesNotMatch(compactFileScannerSource, /mask-image|ritual-scanner-line-glow/)
  ...
  assert.match(scheduleSource, /buy groceries/)
  ...
  assert.match(scheduleSource, /min-h-\[28px\]/)
